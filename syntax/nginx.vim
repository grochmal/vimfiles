" Vim syntax file
" Language: nginx.conf
" Take directly from nginx contrib
" mercurial: http://hg.nginx.org/nginx/file/tip/contrib/vim/syntax
" git mirror: https://github.com/nginx/nginx/tree/master/contrib/vim/syntax
